...
namespace Nop.Plugin.Payments.BrainTree.Data
{
    ...
    /// </summary>
    public class BrainTreeObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public BrainTreeObjectContext(DbContextOptions<BrainTreeObjectContext> options) : base(options)
        {
        }
        ...
        {
            modelBuilder.ApplyConfiguration(new BrainTreeMerchantRecordMap());
        ...
        {
            //drop the table
            this.DropPluginTable(nameof(BrainTreeMerchantRecord));
        }
